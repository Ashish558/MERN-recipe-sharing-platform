...
import { clearIngredients, updateTitle } from '../../../app/slices/searchedRecipes'
import Ingredients from './Ingredients'
import Ingredientinputfield from './InputFields/Ingredient'
import TitleInputField from './InputFields/Title'
import { Form, FormControl, Label, ClearBtn  } from '../../posts/Filter/styles'
    ...
    return (
        <Form className='filter-form' onSubmit={handleSubmit} >
            ...
            <FormControl className='title-input-field form-control'>
                <Label> Title <ClearBtn onClick={()=> dispatch(updateTitle('')) } >clear</ClearBtn></Label>
               <TitleInputField />
            </FormControl>
        </Form>
    )
